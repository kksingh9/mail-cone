...
function SideBar() {
  ...
  return (
    <div className='sidebar'>
      <Button startIcon={<AddIcon />} className='compose__btn' onClick={composeHandler}>Compose</Button>

      <SidebarOptions Icon={InboxIcon} title={"Inbox"} number={234} isactive={true} />
      <SidebarOptions Icon={StarRateIcon} title={"Starred"} number={235} />
      <SidebarOptions Icon={WatchLaterIcon} title={"Snoozed"} number={634} />
      <SidebarOptions Icon={LabelImportantIcon} title={"Important"} number={134} />
      ...
      <SidebarOptions Icon={KeyboardIcon} title={"Join a meeting"} number={44} />
    </div>
  )
}
